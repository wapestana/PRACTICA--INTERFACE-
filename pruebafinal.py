...
frame_grid = None
canvas_wordle = None
bg_wordle_photo = None
text_feedback_id = None

# Variables para el fondo del menú principal
fondo_pil = None
bg_photo = None
...
# ====================================================================================
# CONFIGURACIÓN DE LA VENTANA PRINCIPAL Y UTILIDADES GENERALES
# ====================================================================================
root = Tk()
...
# ====================================================================================
# CLASE Y VENTANAS DEL JUEGO DE TRIVIA
# ====================================================================================
class TriviaUCABApp:
    def __init__(self, root, player_name):
        ...
        self.questions_db = [
            ...
            {"nivel": 12, "pregunta": "Según el reconocido QS World University Rankings de los últimos años, ¿Qué posición ocupa la UCAB entre las universidades PRIVADAS de Venezuela?", "opciones": ["Primer lugar", "Segundo lugar", "Tercer lugar", "Cuarto lugar"], "respuesta": "Primer lugar"},
    ...
    def create_ui_elements(self):
        ...
        for i, pos in enumerate(positions):
            ...
            text_id = self.canvas.create_text(x_c, y_c, text="", font=("Arial", 15, "bold"), fill=self.color_green, 
    ...
    def load_question(self, index):
        if index < self.num_questions:
            self.buttons_active = True
            for i in range(4): self.set_button_color(i, self.color_gold, self.color_green)
...
# ====================================================================================
# INTERFAZ PRINCIPAL (MENÚ) Y RENDERIZADO
# ====================================================================================
...
def dibujar_ui():
    ...
    txt = main_canvas.create_text(bx, by, text="Salir de la App :(", fill="white",
