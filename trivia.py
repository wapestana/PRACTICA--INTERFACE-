...
class TriviaUCABApp:
    ...
    def load_question(self, index):
        if index < self.num_questions:
            ...
            messagebox.showinfo("¡Felicidades!", "🎓 ¡Has completado la Trivia UCAB con éxito!")
            self.root.destroy()
    ...
    def game_over(self):
        messagebox.showerror("Fin del Juego", "💀 Te has quedado sin vidas. ¡Inténtalo de nuevo!")
        self.root.destroy()
...
# ----------------- ¡AQUÍ ESTÁ LA MAGIA DE LA TRIVIA MODIFICADA! -----------------
def abrir_ventana_trivia():
    ...
    def iniciar_juego():
        ...
        app = TriviaUCABApp(v)     # Inicia la Trivia
